  ...
  if (reports.length === 0 && currentFilter === 'all') {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">{t('reports.emptyDescription')}</p>
        <Button asChild>
      ...
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          <HugeiconsIcon
            ...
            aria-hidden="true"
          />
          <p className="text-gray-600 dark:text-gray-400">{t('reports.noResults')}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        {t('reports.showing', { count: totalCount })}
      </p>
  ...
  return (
    <div className="flex flex-wrap gap-4">
      <div className="flex items-center gap-2">
        <HugeiconsIcon icon={FilterIcon} size={16} className="text-gray-500" aria-hidden="true" />
...
function ReportCard({ report }: ReportCardProps) {
  ...
  return (
    <Link
      ...
      className="block bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4 hover:shadow-md hover:border-gray-300 dark:hover:border-gray-700 transition-all"
    >
      <div className="flex gap-4">
        {/* Photo Thumbnail */}
        {report.photos?.[0] && (
          <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-lg overflow-hidden shrink-0 bg-gray-100 dark:bg-gray-800">
            <Image
              src={report.photos[0]}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-2">
            <div>
              ...
              {report.address && (
                <p className="text-sm text-gray-600 dark:text-gray-400 truncate max-w-50 md:max-w-none">
                  {report.address}
                </p>
              )}
            </div>
